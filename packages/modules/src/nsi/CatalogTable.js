...
import {nsi as nsiService} from '@ursip-box-front/services';
import {arrayToTree} from '@ursip-box-front/utils';
...
function CatalogTable() {
  ...
  return (
    <StyledCard ref={wrapperRef}>
      <StyledTable
        data={
          arrayToTree(data, {id: 'elementId', parentId: 'parentId'}).rootItems
        }
        isTree
        rowKey="elementId"
